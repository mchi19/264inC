...
/*
 * Given the head of a list, swap the value attributes at the two nodes with the given indices
...
/*
 * Given the head of a list, find and return the value of the node in the list with
...
/*
 * Given the head of a list, write the value val to the node with the
